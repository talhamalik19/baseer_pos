...
import WarehouseInventoryUsageReport from "@/components/blocks/Reports/WarehouseInventoryUsageReport";

export default async function WarehouseInventoryUsagePage() {
  ...
  const submitWarehouseInventoryUsageReport = async (apiUrl) => {
    "use server";
  ...
  return (
    <>
      <PageHead
        pageName={serverLanguage?.csvTranslations?.warehouse_inventory_usage_report ?? "Warehouse Inventory Usage"}
        firstName={firstname}
        lastName={lastname}
        initials={initials}
      ...
      />
      <WarehouseInventoryUsageReport
        submitWarehouseInventoryUsageReport={submitWarehouseInventoryUsageReport}
        storeCode={storeCode}
      />
    </>
  );
