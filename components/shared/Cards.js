  ...
  return (
    <div className={`${style.card} ${isHighlighted ? style.highlight : ""}`}>
      ...
      <div className={style.price_info}>
        ...
        {cards && item?.__typename !== "ConfigurableProduct" && (
          <div className={style.link} onClick={(e) => e.stopPropagation()}>
            <div className={style.itemControls}>
              <div className={style.quantityControls}>
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleQuantityButtonChange(-qtyIncrementStep);
                  }}
                >
                  -
                </button>
      ...
      {record && item?.__typename !== "ConfigurableProduct" && (
        <div className={style.btns}>

          <div className={style.priceInputContainer} onClick={(e) => e.stopPropagation()}>
