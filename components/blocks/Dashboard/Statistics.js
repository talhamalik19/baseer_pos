  ...
  const statistics = [
    {
      ...
      statePrice: `${res?.data?.sales?.status == "up" ? '+' : '-'}${res?.data?.sales?.earning_percentage}%`,
      svg: (
        <svg
          width="24"
          height="24"
    ...
    },
    {
      ...
      statePrice: `${res?.data?.orders?.status == "up" ? '+' : '-'}${res?.data?.orders?.order_percentage}%`,
      detail: "Detail",
      link: '/order',
      svg: (
        <svg
    ...
    },
    {
      ...
      statePrice: `${res?.data?.customers?.status == "up" ? '+' : '-'}${res?.data?.customers?.customers_percentage}%`,
      svg: (
        <svg
          width="24"
          height="24"
      ...
      {statistics.map((item, index) => (
        <div className={style.stat_cards} key={index}>
          <div className={style.stat_card_text}>
            ...
            <span className={`${item.state === "up" ? style.success : style.error}`}>
            {item?.state == "up" ? (
                <svg
                  width="6"
                  height="8"
                ...
                >
                  <path
                    d="M5.33332 3.72201L2.99999 1.38867M2.99999 1.38867L0.666656 3.722M2.99999 1.38867L2.99999 7.61089"
                    stroke="white"
                  />
                </svg>
              ) : (
                ...
                >
                  <path
                    d="M4.66671 7.77799L7.00004 10.1113M7.00004 10.1113L9.33337 7.778M7.00004 10.1113L7.00004 3.88911"
                    stroke="#E6E6E6"
                  />
                </svg>
              )}
