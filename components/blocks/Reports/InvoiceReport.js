...
export default function InvoiceReport({
  ...
  const buildUrl = (page = 1) => {
    ...
    return `${storeCode}/V1/pos/sales-invoice-report?${params.toString()}`;
  };

  const fetchInvoiceReport = async (page = 1) => {
    ...
    try {
      ...
      console.error("Error loading invoice report:", err);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className={styles.page_detail}>
        ...
        <div className={styles.filter_grid}>
          <div className={styles.filter_group}>
            ...
            >
              ...
              <option value="invoiced">Last Invoice Created Date</option>
            </select>
          </div>
      ...
      <div className={dashboardTable.orders}>
        <div className={dashboardTable.order_head}>
          <h2 className={dashboardTable.title}>Invoice Report</h2>
        </div>
        {data.items.length > 0 && (
          <button
            type="button"
